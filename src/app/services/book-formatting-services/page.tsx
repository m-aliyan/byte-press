...
export default function BookPublishingServices() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between h-full">
          <div className="max-w-3xl text-left ml-8 md:ml-16 lg:ml-24">
            ...
            <p className={`text-base md:text-lg text-black mb-6 leading-relaxed transition-all duration-1000 delay-[200ms] ${
              ...
              Ready to get your book print-ready and platform-approved? We'll handle the formatting so your story takes center stage.
            </p>
          ...
          {/* Formatting Image on Right Side */}
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">A Book Formatting Company That </span>
                  <span className="text-[#0B3C74]">Knows the Finish Matters</span>
                </h2>
                ...
                <div className={`space-y-3 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[120ms] ${
                  ...
                  <p>
                    We are more than a book formatting company; we're your last mile to the finish line. Whether you're formatting a book for print, digital, or both, our team knows how to make it clean, readable, and professionally aligned with publishing standards.
                  </p>
                  
                  <p>
                    We deliver a sharp, consistent book formatting service that's custom-built to match your genre, audience, and goals. From typography and spacing to layout flow, every Expert Format book we produce is designed to support your story without distraction.
                  </p>
                  
                  <p>
                    Let us handle the technical while you stay focused on your content.
                  </p>
                </div>
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-[#0B3C74]">A Book Formatting Solution That Balances</span>
                  <span className="text-gray-900"> Style and Structure</span>
                </h2>
                ...
                <div className={`space-y-4 text-gray-700 text-lg leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
                    Our Book Formatting Services handle font control, layout flow, and spacing with expert precision. The result is a book that looks as strong as it reads — built to meet professional standards and impress from the first page.
                  </p>
                </div>
            ...
            <div className="flex items-center justify-end">
              <div className="max-w-2xl text-left">
                <h2 className={`text-2xl md:text-3xl font-black mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">Manuscript Formatting That Makes </span>
                  <span className="text-[#0B3C74]">Every Page Speak</span>
            </h2>
                ...
                <div className={`space-y-4 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
                    We follow the standard manuscript format while adapting it to match your genre and publishing path. Our expert team delivers manuscript formatting services that handle margins, alignment, spacing, and flow with precision. The result is a book that's easy to read, professionally styled, and built to meet expectations on every platform.
                  </p>
                </div>
      ...
      {/* Section 6 - Full Viewport Height with Text Left and Image Right */}
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">Book Formatting Online Made Simple, </span>
                  <span className="text-[#0B3C74]">Sharp, and Seamless</span>
                </h2>
                ...
                <div className={`space-y-4 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
                    With us, you don't need to navigate formatting on your own. Our book formatting online process is clear from the first step. You upload your manuscript, tell us what you need, and we handle the rest with precision.
                  </p>
                  
                  <p>
                    Our team offers professional book formatting online services for both print and digital publishing. Whether you're working with strict layout specs or just need a clean finish, your personal book formatter will fine-tune the details so your manuscript looks polished and reads beautifully on any platform.
                  </p>
                </div>
      ...
      {/* Section 7 - 4 Flipable Cards with Heading */}
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <div className="text-center mb-12 pt-8">
              ...
              <p className={`text-gray-700 text-base leading-relaxed max-w-3xl mx-auto transition-all duration-1000 delay-[100ms] ${
                ...
                We don't just clean up pages — we build a layout that works as hard as your words. Here's how we stand out:
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#111827] mb-16">
              Got Formatting Questions? We've Got <span className="text-[#0B3C74]">Straight Answers</span>
            </h2>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(0)}
                >
                  <span className="font-semibold text-gray-900">Q: What is book formatting, and why does it matter?</span>
                  <svg
                ...
                {openFAQ === 0 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      Formatting your book ensures that the structure, spacing, and layout look professional and easy to read. It's not just visual polish — it's the foundation for a solid publishing experience.
                    </p>
                  </div>
                )}
              </div>
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(1)}
                >
                  <span className="font-semibold text-gray-900">Q: What types of book formatting solutions do you offer?</span>
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                ...
                {openFAQ === 1 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      We offer full-service Book Formatting Solutions for print and digital, including layout design, margin alignment, font control, and format optimization for all major platforms.
                    </p>
                  </div>
                )}
              </div>
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(2)}
                >
                  <span className="font-semibold text-gray-900">Q: Can you follow a specific style or layout I already have?</span>
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                ...
                {openFAQ === 2 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      Absolutely. If you have preferences or existing guidelines, our team adapts to your needs. Expert Book Formatting isn't one-size-fits-all — we customize every project.
                    </p>
                  </div>
                )}
              </div>
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(3)}
                >
                  <span className="font-semibold text-gray-900">Q: How long does the formatting process take?</span>
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                ...
                {openFAQ === 3 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      Most projects take 5 to 10 business days, depending on book length and complexity. We'll give you a clear timeline upfront, so there are no surprises.
                    </p>
                  </div>
                )}
              </div>
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(4)}
                >
                  <span className="font-semibold text-gray-900">Q: Do you work with both print and eBook formats?</span>
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                ...
                {openFAQ === 4 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      Yes. As leading publishers for formatting, we handle layout for paperbacks, hardcovers, and all major eBook platforms — including Kindle, Apple Books, and Kobo.
                    </p>
                  </div>
                )}
              </div>
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  onClick={() => toggleFAQ(5)}
                >
                  <span className="font-semibold text-gray-900">Q: What makes your team different from a regular book formatter?</span>
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${
                ...
                {openFAQ === 5 && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-700 leading-relaxed">
                      We go beyond templates. Our team brings real publishing insight and delivers every formatting book project with precision, clarity, and platform compatibility baked in.
                    </p>
                  </div>
                )}
              </div>
