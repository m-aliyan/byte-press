...
import { marketingFAQData } from '../../../data/faqData-marketing';
        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between h-full">
          <div className="max-w-3xl text-left ml-8 md:ml-16 lg:ml-24">
            <h1 className={`text-2xl md:text-3xl lg:text-4xl font-black mb-4 leading-tight transition-all duration-1000 ${
              ...
              <span className="text-[#0B3C74]">Book Marketing</span> <span className="text-black">That Drives Sales & Builds Your Audience</span>
            </h1>
            <p className={`text-base md:text-lg text-black mb-6 leading-relaxed transition-all duration-1000 delay-[100ms] ${
              section1Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
At BytePress, we offer comprehensive book marketing services designed to maximize your book's visibility and sales potential. Whether you're launching a new book or promoting an existing title, our marketing experts create targeted campaigns that reach your ideal readers and drive meaningful engagement. Every strategy is crafted with your book's unique story in mind, ensuring maximum impact across all marketing channels.
            </p>
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-[#0B3C74]">Book Marketing Company</span>
                </h2>
                ...
                <div className={`space-y-3 text-gray-700 text-sm leading-relaxed transition-all duration-1000 delay-[120ms] ${
                  ...
                  <p>
Whether you're launching your first book or promoting your latest release, your story deserves more than just basic promotion. At our core, we provide comprehensive book marketing services that focus on audience targeting, brand building, and sales optimization—so your book reaches the readers who will love it most.
                  </p>
                  
                  <p>
We offer a full spectrum of book marketing services, including social media campaigns to build your author brand, email marketing to nurture your reader community, and strategic advertising to boost book sales. Our marketing team works across all platforms, creating compelling content and targeted campaigns to ensure your book gets the attention it deserves.
                  </p>
                  
                  <p>
Every marketing campaign we create is approached with care, precision, and the understanding that each author's brand is unique. Whether you're promoting a fiction novel, nonfiction guide, or memoir, our team ensures your marketing strategy aligns with your book's message and reaches your target audience effectively.
                  </p>
                  
                  <p>
As the best book marketing company, we don't just promote your book. We build your author platform and create lasting reader relationships. Because when your story is ready for the world, it should reach the right readers and create meaningful connections that last beyond the sale.
                  </p>
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-[#0B3C74]">Strategic Book Marketing That Builds</span>
                  <span className="text-gray-900"> Your Author Platform</span>
                </h2>
                <div className={`space-y-4 text-gray-700 text-sm leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  section3Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}>
                  <p>
Great book sales don't just happen; they're built through strategic marketing, layer by layer. Our Professional Book Marketing Services are designed to help authors build stronger reader connections, deeper brand recognition, and clearer market positioning from the ground up. If you've been searching for marketing that goes beyond basic promotion, this is it.
                  </p>
                  
                  <p>
From social media strategy to email marketing campaigns, our Book Marketing Services focus on strengthening your author brand while preserving your unique voice. Whether it's fiction, nonfiction, or memoir, our marketing experts offer professional book promotion that's strategic, thoughtful, and results-driven.
                  </p>
                  
                  <p>
We provide comprehensive book marketing with a personal touch, so even if you're promoting from afar, it feels like you're working right beside us. With expert strategy, brand-level insight, and detailed campaign management, we help turn your book into a bestseller.
                  </p>
                  
                  <p>
This isn't just marketing, it's real partnership for authors ready to build what matters most—their reader community.
                  </p>
                </div>
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">Book Marketing That's Fast, Effective, </span>
                  <span className="text-[#0B3C74]">and Gets Results</span>
                </h2>
                ...
                <div className={`space-y-4 text-gray-700 text-sm leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
Book launches don't wait. That's why our Professional Marketing Services are built for speed without sacrificing quality. Whether you're an indie author, a seasoned writer, or launching your first book, our marketing team works fast to create campaigns, build buzz, and drive sales.
                  </p>
                  
                  <p>
Each marketing specialist at BytePress is trained to identify opportunities others miss, so your book lands in front of the right readers at the perfect time. Our book marketing services combine speed, precision, and real publishing industry insight.
                  </p>
                  
                  <p>
Need your book promoted before a tight launch deadline? Want last-minute marketing that still feels comprehensive? You can count on us to deliver effective, ready-to-launch campaigns on time and done right.
                  </p>
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <div className="text-center mb-12 pt-8">
              <h2 className={`text-3xl md:text-4xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                ...
                <span className="text-black">Shaping Your Marketing Journey with </span>
                <span className="text-[#0B3C74]">Strategy That Converts</span>
              </h2>
              <p className={`text-gray-700 text-base leading-relaxed max-w-3xl mx-auto transition-all duration-1000 delay-[100ms] ${
                section7Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
Getting your book in front of the right readers starts with a smart marketing plan. We don't rush the process — we refine it. From your book's first campaign to the final optimization, every step is handled with precision, so your story reaches exactly who it should.
              </p>
            </div>
              ...
              <div className="flip-card group">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-front bg-white rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    ...
                    <h3 className="text-xl font-bold text-[#0B3C74] text-left leading-tight">Market Research & Analysis</h3>
                  </div>
                  {/* Back Side */}
                  <div className="flip-card-back bg-[#0B3C74] rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    ...
                    <p className="text-white text-sm leading-relaxed text-left">
                      We begin by analyzing your book and target market to identify opportunities and competitive advantages. Our marketing experts assess your audience, positioning, and market trends to prepare a clear marketing strategy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-card group">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-front bg-white rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    ...
                    <h3 className="text-xl font-bold text-[#0B3C74] text-left leading-tight">Campaign Strategy & Planning</h3>
                  </div>
                  {/* Back Side */}
                  <div className="flip-card-back bg-[#0B3C74] rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    <div className="text-white text-4xl font-bold mb-4 border-2 border-white rounded-full w-12 h-12 flex items-center justify-center">
                    ...
                    <p className="text-white text-sm leading-relaxed text-left">
                      Next, we create a targeted marketing plan based on your goals and audience. Whether your focus is social media, email marketing, or paid advertising, we build a strategy that fits your book's unique story.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-card group">
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-front bg-white rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    ...
                    <h3 className="text-xl font-bold text-[#0B3C74] text-left leading-tight">Content Creation & Execution</h3>
                  </div>
                  {/* Back Side */}
                  <div className="flip-card-back bg-[#0B3C74] rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    <div className="text-white text-4xl font-bold mb-4 border-2 border-white rounded-full w-12 h-12 flex items-center justify-center">
                    ...
                    <p className="text-white text-sm leading-relaxed text-left">
                      Our expert marketers jump in with focused content creation and campaign execution. Every post is optimized, every message aligned with your brand voice and marketing goals to create maximum engagement.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flip-card group">
                <div className="flip-card-inner">
                  <div className="flip-card-front bg-white rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    ...
                    <h3 className="text-xl font-bold text-[#0B3C74] text-left leading-tight">Optimization & Growth</h3>
                  </div>
                  {/* Back Side */}
                  <div className="flip-card-back bg-[#0B3C74] rounded-xl p-6 shadow-lg flex flex-col items-start justify-start h-80">
                    <div className="text-white text-4xl font-bold mb-4 border-2 border-white rounded-full w-12 h-12 flex items-center justify-center">
                    ...
                    <p className="text-white text-sm leading-relaxed text-left">
                      Before campaigns conclude, we optimize performance and scale successful strategies. Your marketing leaves our hands refined, consistent, and ready to drive sustained growth.
                    </p>
                  </div>
                </div>
              </div>
      ...
      */}
      ...
      <FAQAccordion 
        faqData={marketingFAQData}
        title="Questions Writers Actually Ask Us"
        subtitle="Before you dive into your next marketing campaign or book launch, here are some answers that might save you time — and maximize your book's success."
      />
