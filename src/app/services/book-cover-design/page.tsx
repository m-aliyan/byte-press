...
import { bookCoverDesignFAQData } from '../../../data/faqData-book-cover-design'; // Book cover design FAQ data
...
export default function BookCoverDesign() {
  ...
  // Intersection Observer for Section 6 animations (Testimonials)
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between h-full">
          <div className="max-w-3xl text-left ml-8 md:ml-16 lg:ml-24">
            <h1 className={`text-2xl md:text-3xl lg:text-4xl font-black mb-4 leading-tight transition-all duration-1000 ${
              ...
              <span className="text-[#0B3C74]">Book Cover Design:</span> <span className="text-black">Make Your Book Stand Out</span>
            </h1>
            <p className={`text-base md:text-base text-black mb-6 leading-relaxed transition-all duration-1000 delay-[100ms] ${
              section1Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              Get a stunning cover for your book with Our Book Cover Design Service
            </p>
            ...
            <div className={`space-y-3 mb-6 transition-all duration-1000 delay-[200ms] ${
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-black font-medium">Customized designs tailored to you</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#0B3C74] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-black font-medium">Professional, high-quality design</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#0B3C74] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-black font-medium">Eye-catching covers that sell</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#0B3C74] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-black font-medium">High-Quality Visuals and Graphics</span>
              </div>
            </div>
          ...
          <div className="flex-shrink-0 mr-8 md:mr-16 lg:mr-24">
            <img 
              src="/services/book-cover2.webp" 
              alt="Book Cover Design Services" 
              className="w-96 h-96 md:w-96 md:h-96 lg:w-[28rem] lg:h-[28rem] object-contain animate-float"
            />
          </div>
        </div>
      </section>
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-2xl md:text-3xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-[#0B3C74]">Why Our Professional Book Cover Design Services</span><br />
                  <span className="text-[#0B3C74]">Can Help Boost Your Sales</span>
                </h2>
                ...
                <div className={`space-y-3 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[120ms] ${
                  ...
                  <p>
                    First impressions matter and that is especially true when it comes to selling your book. With BytePress Book Cover Design Service, you can ensure your book stands out on the shelves in stores and online. Our expert designers will work with you to create a custom, eye-catching cover that will grab readers' attention and increase your book's visibility.
                  </p>
                  
                  <p>
                    Whether you publish your first or fiftieth book, our affordable and professional book cover design services will help you take your sales to the next level. Order now and get noticed!
                  </p>
                </div>
      ...
      {/* Section 3 - Cover Design with Image and Text */}
      <section id="section-3" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Side - Image */}
            <div className="relative">
              <img src="/services/cover-1.png" alt="Book Cover Design" className="w-full h-auto object-cover rounded-lg" />
            </div>
            
            {/* Right Side - Text Content */}
            <div className="space-y-6">
              <h3 className={`text-2xl md:text-3xl font-bold text-[#0B3C74] mb-6 transition-all duration-1000 ${
                section3Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
                Experience Exquisite Quality Affordable Book Cover Designing Service
              </h3>
              ...
              <div className={`space-y-4 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[100ms] ${
                ...
                <p>
                  Self-publishing can be tough, but with BytePress Book Cover Design Service, you can make sure your book looks as professional as those from traditional publishers. Our team of experienced designers will work with you to create a customized and unique book cover that will catch the eye of potential readers.
                </p>
                
                <p>
                  Our services are affordable and tailored to meet the needs of indie authors, so you can focus on what you do best - writing great books. Do not settle for a mediocre cover - order now and take your book to the next level!
                </p>
              </div>
              
              {/* Start Project Button */}
              <div className={`mt-6 transition-all duration-1000 delay-[200ms] ${
      ...
      {/* Section 4 - Customized Book Cover Designs */}
      <section id="section-4" className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h3 className={`text-2xl md:text-3xl font-bold text-[#0B3C74] mb-6 transition-all duration-1000 ${
                ...
                Customized Book Cover Designs to Make Your Book Stand Out
              </h3>
              ...
              <div className={`space-y-4 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[100ms] ${
                ...
                <p>
                  Your book deserves a cover that reflects its unique voice and message. At BytePress, we specialize in creating customized book covers that capture the essence of your book and grab readers' attention.
                </p>
                
                <p>
                  Our designers will work closely with you to understand your vision and create a cover you will love. With our Book Cover Design Service, you can be sure that your book will stand out on the shelves and online and make a lasting impression on potential readers. Order now and take the first step toward publishing success!
                </p>
              </div>
            ...
            {/* Right Side - Image */}
            <div className="relative">
              <img src="/services/cover-2.png" alt="Customized Book Cover Design" className="w-80 h-auto object-cover rounded-lg mx-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      */}
      ...
      <FAQAccordion 
        faqData={bookCoverDesignFAQData}
