        ...
        <div className="container mx-auto px-4 relative z-10 flex items-center justify-between h-full">
          <div className="max-w-3xl text-left ml-8 md:ml-16 lg:ml-24">
            <h1 className={`text-2xl md:text-3xl lg:text-4xl font-black mb-4 leading-tight transition-all duration-1000 ${
              ...
              <span className="text-[#0B3C74]">Exceptional Ghost Writing Services That Turn</span><br />
              <span className="text-black">Ideas Into Finished Books</span><br />
              <span className="text-[#0B3C74]">Powered by Bytes Press</span>
            </h1>
            <p className={`text-base md:text-lg text-black mb-6 leading-relaxed transition-all duration-1000 delay-[100ms] ${
              section1Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              Welcome to Bytes Press, where ideas meet execution. Our expert ghostwriting services are built for authors, entrepreneurs, and storytellers who have something to say but need a hand writing books that resonate. You bring the vision — we write it like it's our own.
            </p>
          ...
          {/* B-Design1 Image on Right Side */}
          <div className="flex-shrink-0 mr-2 md:mr-4 lg:mr-6">
            <img 
              src="/images/bookpublishingpoint_images/b-design1.webp" 
              alt="Book Design" 
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">A Ghostwriting Agency That Knows How to </span>
                  <span className="text-[#0B3C74]">Tell Your Story Right</span>
                </h2>
                ...
                <div className={`space-y-3 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[120ms] ${
                  ...
                  <p>
                    At Bytes Press, we offer professional ghostwriting services for authors who want results without the overwhelm. Whether you're outlining your first idea or already deep into the draft, we're the ghostwriting agency that brings skill, clarity, and speed to the process.
                  </p>
                  
                  <p>
                    Our team has experience ghostwriting books across genres — fiction, memoirs, business, lifestyle, and more. We match you with writers who understand your goals, speak in your voice, and know how to finish what you started.
                  </p>
                  
                  <p>
                    Best of all, we keep it flexible with affordable ghostwriting services that meet you where you are.
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
            ...
            <div className={`flex items-center justify-start transition-all duration-1000 ${
              ...
              <img 
                src="/images/bookpublishingpoint_images/publishing-3.png" 
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-[#0B3C74]">Book Writing Services That Take You from</span>
                  <span className="text-gray-900"> Idea to Shelf</span>
                </h2>
                ...
                <div className={`space-y-4 text-gray-700 text-lg leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
                    At Bytes Press, we offer end-to-end book writing services built to get your story finished and published the right way. Whether you're working with a rough outline or a full draft, we guide you through structure, storytelling, and market prep.
                  </p>
                  
                  <p>
                    Need help with Amazon? Our Amazon Book Writing Service covers everything from positioning to compliance. Add in Professional Book Editing, sharp design, and a streamlined launch, and you've got a book writing company that knows how to get results, not just words on a page.
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
            ...
            <div className={`flex items-center justify-start transition-all duration-1000 ${
              ...
              <img 
                src="/images/bookpublishingpoint_images/ghostwriting-1.png" 
                alt="Ghostwriting Services" 
                className="max-w-lg h-auto object-contain ml-8 mt-16 reveal-img"
              />
            </div>
            ...
            <div className="flex items-center justify-end">
              <div className="max-w-2xl text-left">
                <h2 className={`text-2xl md:text-3xl font-black mb-6 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">Book Writing Process That Keeps You </span>
                  <span className="text-[#0B3C74]">Focused From First Idea to Final Edit</span>
            </h2>
            ...
            <div className="text-center mb-4 pt-4">
              ...
              <div className="max-w-3xl mx-auto">
                <p className={`text-gray-700 text-base leading-relaxed mb-6 transition-all duration-1000 delay-[100ms] ${
                  ...
                  We don't drag you through guesswork. At Bytes Press, our book writing process is focused, clear, and designed to move your story forward — whether you're starting from scratch or refining an existing draft. Here's how it flows:
                </p>
      ...
      <section id="section-7" className="h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center">
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center">
              <div className="max-w-2xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-4 leading-tight transition-all duration-1000 ${
                  ...
                  <span className="text-black">Let's turn your ideas into </span>
                  <span className="text-[#0B3C74]">reality.</span>
                </h2>
                ...
                <div className={`space-y-3 text-gray-700 text-base leading-relaxed transition-all duration-1000 delay-[100ms] ${
                  ...
                  <p>
                    Contact us today to discuss your project and how we can assist you in bringing your vision to life. Our ghostwriting team is ready to transform your ideas into compelling, market-ready books that capture your voice and resonate with your audience.
                  </p>
                  
                  <p>
                    Whether you're an entrepreneur with a business book idea, a professional looking to share your expertise, or someone with a personal story to tell, we have the experience and dedication to make your book a reality.
                  </p>
                </div>
            ...
            <div className={`flex items-end justify-end h-full pt-20 transition-all duration-1000 ${
              ...
              <img 
                src="/images/bookpublishingpoint_images/publishing-2.png" 
