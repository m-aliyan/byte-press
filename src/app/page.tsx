...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 h-[90vh] flex items-center pt-6">
        <div className="container mx-auto px-4 w-full -translate-y-4">
          <div className="grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-sm md:text-base text-gray-600 max-w-2xl lg:max-w-none mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center lg:justify-start">
                <a href="/contact" className="bg-blue-600 text-white px-4 md:px-5 py-2 md:py-2.5 rounded-lg font-medium text-sm hover:bg-blue-700 transition-colors">
                  Start Your Book Project
                </a>
                <a href="/services" className="border border-gray-300 text-gray-700 px-4 md:px-5 py-2 md:py-2.5 rounded-lg font-medium text-sm hover:bg-gray-50 transition-colors">
                  View Our Services
                </a>
              </div>
            </div>
